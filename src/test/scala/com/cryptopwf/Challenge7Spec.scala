...
class Challenge7Spec extends FlatSpec with Matchers {
  "Challenge7" should "decrypt something with AES in ECB" in {
    ...
    val ciphertext = """|CRIwqt4+szDbqkNY+I0qbDe3LQz0wiw0SuxBQtAM5TDdMbjCMD/venUDW9BL
                        ...
                        |S15AVD2QS1V6fhRimJSVyT6QuGb8tKRsl2N+a2Xze36vgMhw7XK7zh//jC2H""".stripMargin.replaceAll("\n", "")
    ...
    Challenge7.decrypt(ciphertext, key) should be (result)
  }
}
